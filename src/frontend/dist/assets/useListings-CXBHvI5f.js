import { r as reactExports, j as jsxRuntimeExports, K as composeRefs, G as reactDomExports, g as useComposedRefs, M as React, N as ReactDOM, O as useBackend, Q as useQuery, T as useQueryClient, V as useMutation, y as ListingCondition } from "./index-DS9SGZgY.js";
...
function mapListing(b) {
  ...
  try {
    ...
    return {
      ...
      sellerId: ((_b = (_a = b.sellerId) == null ? void 0 : _a.toString) == null ? void 0 : _b.call(_a)) ?? "",
      sellerName: b.sellerName ?? "",
      status: b.status,
      createdAt: b.createdAt ?? BigInt(0),
      updatedAt: b.updatedAt ?? BigInt(0),
      brand: b.brand || void 0,
      size: b.size || void 0
    };
  } catch {
    return {
      id: String((b == null ? void 0 : b.id) ?? Math.random()),
      title: (b == null ? void 0 : b.title) ?? "Unknown",
      description: "",
...
function useListings(filter) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      try {
        if ((filter == null ? void 0 : filter.query) || (filter == null ? void 0 : filter.category)) {
          const page2 = await actor.searchListings(
            filter.query ?? "",
            filter.category ?? null,
            BigInt(0),
            BigInt(100)
          );
          return (page2.listings ?? []).map(mapListing);
        }
  ...
  return useMutation({
    mutationFn: async (args) => {
      ...
      const backendArgs = {
        ...
        images: args.images,
        brand: args.brand || void 0,
        size: args.size || void 0
      };
...
export {
  ...
  useDeleteListing as d,
  useMarkListingAsSold as e,
  useUpdateListing as f,
  useListings as g,
