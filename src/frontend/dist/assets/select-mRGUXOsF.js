import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as cn, X, g as useComposedRefs, G as reactDomExports } from "./index-DS9SGZgY.js";
import { B as Badge } from "./badge-Da6mwtC-.js";
import { C as ChevronDown } from "./chevron-down-DDfZ2P0s.js";
import { P as Primitive, i as useControllableState, R as Root2$1, j as useId, A as Anchor, k as composeEventHandlers, h as useLayoutEffect2, l as Portal$1, m as createPopperScope, r as useCallbackRef, n as hideOthers, p as useFocusGuards, o as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, c as createContextScope, a as createSlot, C as Content, q as Arrow } from "./useListings-CXBHvI5f.js";
import { u as useDirection, c as createCollection } from "./index-JPtkJw_u.js";
/**
...
function CategoryFilter({
  ...
  if (collapsible) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("w-full", className), "data-ocid": "category_filter", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-left", children: selected ? selected : "All categories" }),
            activeCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary text-primary-foreground text-xs h-5 min-w-5 px-1.5", children: activeCount }),
      ...
      open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 p-3 rounded-xl bg-card border border-border shadow-elevated", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: cn(
                ...
                !selected ? "bg-primary text-primary-foreground border-primary" : "bg-muted text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"
              ),
              style: { minHeight: 44 },
              children: "All"
            }
          ...
          CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: cn(
                ...
                selected === cat ? "bg-primary text-primary-foreground border-primary" : "bg-muted text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"
              ),
              style: { minHeight: 44 },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: CATEGORY_ICONS[cat] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: cat }),
                (counts == null ? void 0 : counts[cat]) !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    className: cn(
                      "ml-0.5 text-xs opacity-70",
                      selected === cat ? "text-primary-foreground" : "text-muted-foreground"
                    ),
                    children: [
                      "(",
                      counts[cat],
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: cn(
              ...
              !selected ? "bg-primary text-primary-foreground border-primary" : "bg-card text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"
            ),
            style: { minHeight: 44 },
            children: "All"
          }
        ...
        CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: cn(
              ...
              selected === cat ? "bg-primary text-primary-foreground border-primary" : "bg-card text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"
            ),
            style: { minHeight: 44 },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: CATEGORY_ICONS[cat] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: cat }),
              (counts == null ? void 0 : counts[cat]) !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
